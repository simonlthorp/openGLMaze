...
- (void)compileVertexShader:(NSString *)vertexShader
    ...
    glBindAttribLocation(self.programHandle, 0, "a_pos");
    glBindAttribLocation(self.programHandle, 1, "a_col");
    
    glLinkProgram(self.programHandle);
    
    self.modelViewMatrix = GLKMatrix4Identity;
    _modelViewMatrixUniform = glGetUniformLocation(_programHandle, "view");
    _projectionMatrixUniform = glGetUniformLocation(_programHandle, "projection");
